...
export function Layout1() {
  return (
    <div className="relative mx-auto" style={{ width: "1365px", height: "696px" }}>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[696px] left-1/2 opacity-40 top-1/2 w-[1364px]">
        <img
          alt=""
